...
const translations = {
    ...
    ti: {
        ...
        description: "እዚ መሳርሒ ኣብ ስእሊ/Emoji ወይ ኣብ ማእከል ቃላት ምስጢራዊ መልእኽቲ ንምሕባእ ይሕግዘና። ብተወሰኪ ኣብ ኣብ ውሽጢ መልእኽቲ ወይ ስእልታት ተሓቢኦም ንዝርከቡ ምስጢራት ንምርካብ ይሕግዘና።",
        decode: "መልእክቲ ፍታሕ",
        encode: "መልእክቲ ሕባእ",
        decodeLabel: "ክትፈትሖ ዝደለካ ምስጢር ኣብዚ የእትዎ",
        encodeLabel: "ክትሓብኦ ዝደልካ ምስጢር ኣብዚ የእትዎ",
        encodePlaceholder: "ኣብዚ ወሽጢ ጸሓፎ...",
        decodeBtn: "ኣብዚ ጠዊቅካ ሕብኣዮ",
        encodeBtn: "ኣብዚ ጠዊቅካ ፍትሓዮ/ፍትሓዮ",
        clipboardBtn: "📋 ንክትቀድሖ  ኣብዚ ጠውቅ",
        clipboardText: "ንክትቀድሖ ኣብዚ  ጠውቅ",
        clipboardHint: "",
        clipboardCopied: "ተቐዲሑ,ሕጂ ሰደዶ ! ✅",
